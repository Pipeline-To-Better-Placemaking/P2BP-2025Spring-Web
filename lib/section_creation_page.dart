...
class _SectionCreationPageState extends State<SectionCreationPage> {
  ...
  String _directions = "Create your section by marking two points by tapping the outside of the polygon area. Then click the check button to confirm.";
  ...
  void _polylineTap(LatLng point) {
    ...
    setState(() {
      ...
      if (_markers.length == 2) {
        ...
        _directions = 'Move the points to your desired spots to create a polyline, then press the finalize button to create the polyline.';
      }
    });
    _currentPoint = point;
  }
  ...
  void _finalizePolyline() {
    setState(() {
      if (_markers.length == 2) {
        ...
        _polyline.add(
          Polyline(
            polylineId: PolylineId('polyline_${_polyline.length + 1}'),  // Increment polyline ID for multiple polylines
            points: _markers.map((marker) => marker.position).toList(),
            color: Colors.green,
            width: 5,
          ),
        ...
        _directions = 'Polyline created. If you are satisfied with it, press the finish button.';
      }
    });
  }
                  ...
                  child: Stack(
                    children: [
                      GoogleMap(
                        ...
                        onTap: _addPointsMode ? _polylineTap : null, // Only allow tapping to add points when _addPointsMode is true
                      ),
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                 color: Color.fromRGBO(0, 0, 0, 0.1),  // RGBA format (Red, Green, Blue, Alpha),
                                  blurRadius: 6,
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: MouseRegion(
                            onEnter: (_) => setState(() {
                              _addPointsMode = false; // Disable adding points when hovering over button
                              _isHoveringOverButton = true;
                            }),
                            onExit: (_) => setState(() {
                              _addPointsMode = true; // Re-enable adding points when not hovering over button
                      ...
                      Align(
                        alignment: Alignment.bottomLeft,
                        child: Padding(
                          padding: EdgeInsets.only(left: 10.0, bottom: 210.0), // Adjusted padding
                          child: MouseRegion(
                            onEnter: (_) => setState(() {
                              _addPointsMode = false; // Disable adding points when hovering over button
                              _isHoveringOverButton = true;
                      ...
                      Padding(
                        ...
                        child: Align(
                          ...
                          child: FilledButton.icon(
                            ...
                            onPressed: (_isLoading || _polyline.isEmpty || _polyline.first.points.length != 2)
                                ? null
                                : () {
                                    try {
                                      setState(() {
                                      ...
                                      final pointsToSave = _polyline.first.points;
                                      Navigator.pop(context, pointsToSave.toGeoPointList());
                                    } catch (e, stacktrace) {
